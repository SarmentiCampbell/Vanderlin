...
/proc/show_blurb(client/C, duration, blurb_text, fade_time = 5, text_color = "white", outline_color = "black", text_align = "left", screen_location = "CENTER,CENTER")
	if(!C)
		return
	...
	if(!findtext(text, "style="))
		text = "<span style=\"color:[text_color]\">[text]</span>"
...
/proc/show_global_blurb(duration, blurb_text, fade_time = 5, text_color = "white", outline_color = "black", text_align = "left", screen_location = null)
